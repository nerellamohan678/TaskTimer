...
class MainActivity : AppCompatActivity()
    ...
    lateinit var task_details_container: FrameLayout
    lateinit var mainFragment : Fragment
    lateinit var current_task : TextView
...
//    private val viewModel by lazy { ViewModelProvider(this).get(TaskTimerViewModel::class.java)}
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        task_details_container = findViewById(R.id.task_details_container)
        mainFragment = supportFragmentManager.findFragmentById(R.id.mainFragment)!!
        current_task = findViewById(R.id.current_task)
        mTwoPane = resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE//checks if it is in landscape
        ...
        if(fragment != null) {
            ...
            task_details_container.visibility = if(mTwoPane) View.INVISIBLE else View.GONE//if fragment is not opened at all then no pane will be visible
            mainFragment.view?.visibility = View.VISIBLE//only this will be visible
        }
    ...
    private fun removeEditPane(fragment: Fragment? = null) {
        ...
        supportActionBar?.setDisplayHomeAsUpEnabled(false)//to remove the up button
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.menumain_adddTask -> taskEditRequest(null)
